...
<?php $component->withAttributes(['heading' => 'Publish New Product']); ?>
        <form method="POST" action="/<?php echo e(app()->getLocale()); ?>/admin/products/status_jobs" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <?php
                $result=[];
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH /home/vitalii/Desktop/PhpstormProjects/sp/test price/shop/resources/views/admin/products/job/create.blade.php ENDPATH**/ ?>