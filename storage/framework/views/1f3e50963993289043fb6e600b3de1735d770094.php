<div x-data="{ open: false, selectedOption: '' }" x-init="checkModalStatus()" style="display: none;">
    ...
    ">
        <div class="modal-content" style=" background-color: #fff;
            ...
            <form action="<?php echo e(url('/'.app()->getLocale().'/save-survey')); ?>" method="post">
                <?php echo csrf_field(); ?>
                <div>
...
<?php /**PATH /home/vitalii/Desktop/PhpstormProjects/sp/test price/shop/resources/views/components/modals/survey.blade.php ENDPATH**/ ?>