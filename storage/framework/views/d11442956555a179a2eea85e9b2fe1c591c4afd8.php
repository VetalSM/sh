    ...
    <div class="flex">
        <aside class="w-48 flex-shrink-0">
            ...
            <ul>
                ...
                <li>
                <a href="/<?php echo e(app()->getLocale()); ?>/admin/products/orders" class="<?php echo e(request()->is('admin/products/orders') ? 'text-blue-500' : ''); ?>">All Order</a>
                </li>
                <li>
                    <a href="/<?php echo e(app()->getLocale()); ?>/admin/products/balance_products/create" class="<?php echo e(request()->is('admin/products/balance_products/create') ? 'text-blue-500' : ''); ?>">новый продукт</a>
                </li>
...
<?php /**PATH /home/vitalii/Desktop/PhpstormProjects/sp/test price/shop/resources/views/components/setting.blade.php ENDPATH**/ ?>