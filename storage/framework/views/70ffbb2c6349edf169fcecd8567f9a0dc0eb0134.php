...
<?php $component->withAttributes(['heading' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Edit Product: ' . $status->name)]); ?>
        <form method="POST" action="/<?php echo e(app()->getLocale()); ?>/admin/products/status_jobs/<?php echo e($status->id); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
<?php endif; ?>
            ...
            <?php $__currentLoopData = \App\Models\Product::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option class="rounded-full"
                            value="<?php echo e($product->id); ?>" ><?php echo e($product->title); ?> <br>текущий прайс<<<?php echo e($product->prices); ?>>> </option>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH /home/yx479316/madeis.com.ua/www/resources/views/admin/products/job/edit.blade.php ENDPATH**/ ?>