...
<?php $component->withAttributes(['class' => 'bg-gray-50']); ?>
    <article class="flex space-x-4">
        ...
        <div>
            <header class="mb-4">
                <h5 class="font-bold"><?php echo e(ucwords($comment->name)); ?></h5>
...
<?php endif; ?>
<?php /**PATH /home/yx479316/madeis.com.ua/www/resources/views/components/product-comment.blade.php ENDPATH**/ ?>