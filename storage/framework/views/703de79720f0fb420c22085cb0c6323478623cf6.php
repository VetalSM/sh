                        ...
                        <select name="price" class="bt rounded-full py-2 px-2 ">
                            <?php $__currentLoopData = $sorted; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $price): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option class="rounded-full"
                                        value="<?php echo e($d=$price->price); ?>"><?php echo e($price->weight); ?><?php echo e($price->unit); ?> <?php echo e($price->price); ?><?php echo e($price->currency); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                        <?php $price = DB::table('prices')->where('price', "$d")->first()  ?>
                        <?php if(!isset($price->currency)): ?>
                        <?php endif; ?>
                        <input type="hidden" value="<?php echo e($price->weight); ?>" name="weight">
                        <input type="hidden" value="<?php echo e($price->unit); ?>" name="unit">
                        <input type="hidden" value="<?php echo e($price->currency); ?>" name="currency">
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH /home/vitalii/Desktop/PhpstormProjects/sp/test price/shop/resources/views/products/show.blade.php ENDPATH**/ ?>