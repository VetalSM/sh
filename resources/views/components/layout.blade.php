...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="/public/images/title/apple-touch-icon.png">
    <link rel="icon" type="image/png" sizes="32x32" href="/public/images/title/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="16x16" href="/public/images/title/favicon-16x16.png">
    <link rel ="icon" type = "image/x-icon" href ="/public/images/title/title.png">
    <link rel="manifest" href="/public/images/title/site.webmanifest">
    <link rel="mask-icon" href="/public/images/title/safari-pinned-tab.svg" color="#5bbad5">
